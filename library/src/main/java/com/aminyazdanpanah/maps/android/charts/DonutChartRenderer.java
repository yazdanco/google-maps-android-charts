...
public class DonutChartRenderer extends ChartRenderer {
    ...
    public DonutChartRenderer(Context context, GoogleMap map, ClusterManager<CMarker> clusterManager) {
        super(context, map, clusterManager);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View donutChart = inflater.inflate(R.layout.donutchart_cluster, null);
    ...
    protected void onBeforeClusterRendered(Cluster<CMarker> cluster, MarkerOptions markerOptions){
        ...
        DonutChart Chart = new DonutChart(values(cluster), COLORS);
