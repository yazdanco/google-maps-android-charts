...
public class PieChartRenderer extends ChartRenderer {
    ...
    public PieChartRenderer(Context context, GoogleMap map, ClusterManager<CMarker> clusterManager) {
        super(context, map, clusterManager);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View pieChart = inflater.inflate(R.layout.piechart_cluster, null);
        mClusterIconGenerator.setContentView(pieChart);
        mClusterImageView = pieChart.findViewById(R.id.image);
    }
    ...
    protected void onBeforeClusterRendered(Cluster<CMarker> cluster, MarkerOptions markerOptions) {
        ...
        PieChart Chart = new PieChart(values(cluster), COLORS);
